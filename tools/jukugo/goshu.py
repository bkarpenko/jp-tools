...
def branch(wtype: str, in_suw: bool, in_luw2: bool,
    ...
    out.append("")
    out.append("ДАЛЬШЕ — шаг 2, такт 1: статьи СЛОВА, обе.")
    out.append("  1. 精選版日本国語大辞典 — достать самому: веб-поиск")
    out.append("     «<слово> kotobank 精選版 日本国語大辞典», потом загрузка")
    out.append("     ссылки из выдачи. У Бориса не просить.")
    out.append("  2. hanyucidian.org — за подпиской, запросить у Бориса.")
