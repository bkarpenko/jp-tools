...
def branch(wtype: str, in_suw: bool, in_luw2: bool,
    ...
    if wtype == "和":
        ...
        out.append("  Ветка — плейсхолдер: см. SKILL.md, «Ветка В». Сказать это")
    ...
    out.append("  до шага 3 неизвестно, из какого словаря они понадобятся.")
    return out
...
def report(word: str) -> int:
    ...
    if n_kanji < 2:
        ...
        print("  но не проверено (SKILL.md, «Ветка Д»).")
